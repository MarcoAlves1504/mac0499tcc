...
int main() {
	...
	Basta mudar o tipo da variável "busca", não é necessário alterar mais nada dentro desse arquivo,
	já que ambas as classes tem os mesmos métodos e interfaces.*/
